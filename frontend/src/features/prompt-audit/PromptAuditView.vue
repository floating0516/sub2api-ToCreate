<template>
  <AppLayout>
    ...
    <div v-if="draft && activeTab === 'config'" class="fixed inset-x-0 bottom-0 z-30 border-t-2 border-gray-900 bg-white px-4 py-3 dark:border-gray-100 dark:bg-dark-900 lg:left-64">
