<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      <router-link
        :to="homePath"
        class="sidebar-logo flex h-9 w-9 items-center justify-center overflow-hidden rounded-lg border border-gray-200 bg-paper-surface transition-opacity hover:opacity-80 dark:border-dark-700 dark:bg-dark-800"
      ...
      <div class="sidebar-brand" :class="{ 'sidebar-brand-collapsed': sidebarCollapsed }" :aria-hidden="sidebarCollapsed ? 'true' : 'false'">
        <router-link
          :to="homePath"
          class="sidebar-brand-title font-serif text-lg font-semibold text-gray-900 transition-colors hover:text-primary-600 dark:text-white dark:hover:text-primary-300"
          @click="handleMenuItemClick(homePath)"
        >
          {{ siteName }}
        </router-link>
...
function buildSelfNavItems(withDashboard: boolean): NavItem[] {
  ...
  items.push(
    ...
    { path: '/orders', label: t('nav.myOrders'), icon: OrderListIcon, hideInSimpleMode: true, featureFlag: flagUserOrders },
    { path: '/redeem', label: t('nav.redeem'), icon: GiftIcon, hideInSimpleMode: true, featureFlag: flagUserRedeem },
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/benefit-grants', label: t('nav.benefitGrants'), icon: GiftIcon, hideInSimpleMode: true },
    ...
    { path: '/admin/daily-report', label: t('nav.dailyReport'), icon: CalendarIcon },
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/admin/custom-build', label: t('nav.customBuild'), icon: DocumentIcon })
