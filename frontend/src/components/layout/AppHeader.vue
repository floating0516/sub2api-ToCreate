    ...
    <div class="flex h-16 items-center justify-between gap-2 px-2 sm:px-4 md:px-6">
      ...
      <div class="flex shrink-0 items-center gap-2 sm:gap-4">
        ...
        <div class="hidden lg:block">
          <h1 class="font-serif text-lg font-medium text-gray-900 dark:text-white">
            {{ pageTitle }}
          </h1>
      ...
      <div class="flex min-w-0 items-center gap-1 sm:gap-3">
        ...
        >
          ...
          <div
            class="pointer-events-none absolute right-0 top-full mt-2 hidden w-56 rounded-lg border border-gray-200 bg-paper-surface p-3 text-xs shadow-lg group-hover:block dark:border-dark-700 dark:bg-dark-800"
          >
