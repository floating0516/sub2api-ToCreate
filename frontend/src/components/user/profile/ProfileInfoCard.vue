    ...
    >
      <div class="px-6 py-6 md:px-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          <div
            class="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-sm border-2 border-gray-900 bg-primary-500 text-2xl font-bold text-gray-900 shadow-lg dark:border-gray-100"
          >
            <img
              v-if="avatarUrl"
              :src="avatarUrl"
