<template>
  <div class="grid w-full min-w-0 grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:items-center sm:gap-3">
    <SearchInput
    ...
    <Select :model-value="filters.group" class="col-span-2 w-full sm:w-40" :options="gOpts" @update:model-value="updateGroup" @change="$emit('change')" />
  </div>
</template>
