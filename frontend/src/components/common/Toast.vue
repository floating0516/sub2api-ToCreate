    ...
    >
      ...
      >
        <div
          ...
          :key="toast.id"
          :class="[
            'toast pointer-events-auto w-[calc(100vw-2rem)] min-w-0 max-w-md overflow-hidden sm:w-auto sm:min-w-[320px]',
            `toast-${toast.type}`
          ]"
        >
          <div class="p-4">
            <div class="flex items-start gap-3">
              ...
              <button
                ...
                class="toast-close -m-1 flex-shrink-0 p-1 text-gray-500 transition-colors"
