          ...
          >
            ...
            <div class="space-y-1.5">
              ...
              <div
                ...
                class="flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary-50 to-primary-100 px-2.5 py-1.5 dark:from-primary-900/20 dark:to-primary-800/20"
              >
