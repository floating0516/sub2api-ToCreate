...
function methodSelectedClass(type: string): string {
  if (isBuiltInAlipayMethod(type)) return 'border-blue-700 bg-blue-50 text-gray-900 shadow-sm dark:bg-blue-950 dark:text-gray-100'
  if (isBuiltInWxpayMethod(type)) return 'border-green-500 bg-green-50 text-gray-900 shadow-sm dark:bg-green-950 dark:text-gray-100'
  if (type === 'stripe') return 'border-primary-500 bg-primary-50 text-gray-900 shadow-sm dark:bg-primary-950 dark:text-gray-100'
  if (type === 'airwallex') return 'border-yellow-500 bg-yellow-50 text-gray-900 shadow-sm dark:bg-yellow-950 dark:text-gray-100'
