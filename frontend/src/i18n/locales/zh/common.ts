export default {
  ...
  auth: {
    ...
    emailFirst: {
      ...
      title: '登录或创建账户',
      emailDescription: '先输入邮箱，接下来只显示当前需要完成的步骤。',
      emailHint: '该邮箱将连接真实账户系统。',
      continueWithEmail: '使用邮箱继续',
      realAccount: '真实账户',
      secureSession: '安全会话',
      signInEyebrow: '账户登录',
      createEyebrow: '创建新账户',
      passwordHint: '请输入该账户对应的密码。',
      sendCode: '发送邮箱验证码',
      verifyEyebrow: '完成邮箱验证',
      checkInbox: '请查收邮箱',
      codeSentTo: '6 位验证码已发送至 ',
      codeHint: '请输入完整的 6 位验证码。',
      verifyCode: '验证验证码',
      twoFactorEyebrow: '两步验证',
      twoFactorTitle: '验证本次登录',
      twoFactorDescription: '请输入身份验证器中对应于以下账户的验证码：',
      signedIn: '已通过认证',
      preparingTitle: '正在准备账户',
      preparingDescription: '正在恢复安全会话和工作空间。',
      ready: '准备完成',
      successTitle: '一切就绪',
      successDescription: '您的账户和工作空间已经可以使用。',
      otherLoginMethods: '使用其他登录方式',
      otherMethodsEyebrow: '其他登录方式',
      otherMethodsTitle: '选择登录方式',
      otherMethodsDescription: '使用当前可用的账户服务或通行密钥继续。',
      emailPasswordMethod: '使用邮箱和密码',
      showPassword: '显示密码',
      hidePassword: '隐藏密码',
      settingsUnavailable: '暂时无法读取账户设置，请重试。',
      legal: '继续即表示您同意适用的服务条款和隐私政策。'
    },
    promoCodeLabel: '优惠码',
