export default {
  ...
  version: {
    ...
    officialProject: '官方项目信息',
    officialRepository: '官方仓库',
    officialBaseline: '当前基线',
    officialLatest: '官方最新',
    officialUpdateAvailable: '发现官方版本 v{version}',
    officialUpdateCustomHint: '请通过 ToCreate 自定义更新流程合并，避免覆盖现有定制功能。',
    officialUpToDate: '当前版本已基于官方最新版。',
    officialCheckUnavailable: '暂未获取到官方最新版，请刷新后重试。',
    refresh: '刷新',
    sourceMode: '源码构建',
    ...
    customUpdateResolverSettings: 'AI 设置',
    customUpdateResolverSettingsTitle: '自动合并模型',
    customUpdateResolverConfigSaved: '已保存为后续冲突处理的默认配置',
    customUpdateResolverUsingDefaults: '当前使用服务器默认配置',
    customUpdateResolverConfigSavedShort: '已保存',
    customUpdateResolverUsingDefaultsShort: '默认',
    customUpdateResolverBaseURL: 'Base URL',
    customUpdateResolverAPIKey: 'API Key',
    customUpdateResolverAPIKeyConfigured: '已保存',
    customUpdateResolverAPIKeyMissing: '未保存',
    customUpdateResolverAPIKeyKeepPlaceholder: '留空保持当前密钥',
    customUpdateResolverAPIKeyPlaceholder: '输入 API Key',
    customUpdateResolverShowAPIKey: '显示 API Key',
    customUpdateResolverHideAPIKey: '隐藏 API Key',
    customUpdateResolverModel: '模型',
    customUpdateResolverModelLuna: 'GPT-5.6 Luna · Max（默认）',
    customUpdateResolverModelTerra: 'GPT-5.6 Terra · Max',
    customUpdateResolverModelCustom: '自定义模型',
    customUpdateResolverCustomModel: '模型 ID',
    customUpdateResolverReasoningMax: '推理强度：Max',
    customUpdateResolverReasoningMaxShort: 'Max',
    customUpdateResolverTestConnection: '测试连接',
    customUpdateResolverTesting: '测试中',
    customUpdateResolverTestSuccess: '连接成功，耗时 {latency} ms',
    customUpdateResolverTestFailed: '连接测试失败',
    customUpdateResolverSaveDefault: '保存为默认配置',
    customUpdateResolverSaveSuccess: '默认配置已保存，API Key 不会在页面回显',
    customUpdateResolverLoadFailed: '加载自动合并配置失败',
    customUpdateResolverSaveFailed: '保存自动合并配置失败',
    ...
    customUpdateStage: '检查官方更新并部署到 18080',
    customUpdateRetry: '重新执行更新',
    customUpdateFlowMerge: '合并官方',
    customUpdateFlowStage: '验证 18080',
    customUpdateFlowPromote: '确认 8080',
    ...
    customUpdateRelease: '本次自定义发布',
    customUpdateReleaseFailed: '正式版本已运行，但 GitHub Release 发布失败',
