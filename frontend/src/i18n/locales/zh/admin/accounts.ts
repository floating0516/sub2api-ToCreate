  ...
  accounts: {
    concurrencyDetails: {
      ...
      openaiQuotaHistory: {
        ...
        usageLegend: '使用率',
        localUsage: '本地用量',
        manualResetLegend: '主动重置',
        providerResetLegend: '官方重置',
        unknownResetLegend: '未知',
        resetSource: '重置类型',
        editResetSource: '调整重置类型',
        closeSourceEditor: '关闭重置类型编辑',
        automaticResult: '自动判断结果',
        autoDetection: '自动判断',
        saveSourceFailed: '保存重置类型失败',
      ...
      openai: {
        ...
        testModeCustomText: '文字测试',
        testModeDraw: '绘图测试',
        thinkingDepth: '思考深度',
        thinkingDepthHint: '先选择模型，再选择思考深度。文字测试和绘图测试都会发给所选 GPT 模型。',
        thinkingNone: '不开启',
        thinkingMinimal: '最低',
        thinkingLow: '低',
        thinkingMedium: '中',
        thinkingHigh: '高',
        thinkingXHigh: '最高',
        customTextPromptLabel: '测试文本',
        customTextPromptPlaceholder: '输入要发给 GPT 的一段文字',
        customTextPromptDefault:
          '请用一段不超过80字的生动文字，描写一只鹈鹕第一次骑自行车的情景，结尾带一个意外的小转折。',
        customTextPromptHint: '这段文字会作为用户消息发给所选 GPT 模型，并带上思考深度。',
        drawPromptLabel: '绘图提示词',
        drawPromptPlaceholder: '创建一个 HTML，内容是 SVG 绘制一个鹈鹕骑自行车的 2D 动画。',
        drawPromptDefault: '创建一个 HTML，内容是 SVG 绘制一个鹈鹕骑自行车的 2D 动画。',
        drawTestHint: '会把这段提示词发给所选 GPT 模型，并把返回的 SVG 在下方播放，而不是位图。',
        customTextTestMode: '模式：文字测试',
        drawTestMode: '模式：绘图测试',
        sendingCustomTextRequest: '正在发送文字测试请求...',
        sendingDrawRequest: '正在向 GPT 发送绘图测试请求...',
      ...
      svgPreview: 'SVG 动画',
      svgPreviewAlt: '测试 SVG {index}',
      svgReceived: '已收到第 {count} 个可播放 SVG',
      replaySvg: '重新播放',
      audioPreview: '生成音频：',
