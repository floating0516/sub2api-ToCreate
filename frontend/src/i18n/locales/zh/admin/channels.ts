export default {
    ...
    subscriptions: {
      ...
      adjustDaysPlaceholder: '输入天数',
      adjustHint: '只需要输入正数天数，系统会根据上方选择自动延长或缩短。',
      adjustModeExtend: '延长',
      adjustModeShorten: '缩短',
      adjustShortenDisabled: '已过期或无到期时间的订阅不能缩短',
      adjustQuickDays: '{days} 天',
      adjustPreview: '调整预览',
      adjustPreviewExtend: '延长 {days} 天',
      adjustPreviewShorten: '缩短 {days} 天',
      newExpiration: '调整后到期时间',
      newRemainingDays: '调整后剩余',
      remainingDaysValue: '{days} 天',
      invalidAdjustDays: '请输入 1 到 36500 之间的整数天数',
      assign: '分配',
      assigning: '分配中...',
      adjust: '调整',
      adjusting: '调整中...',
      ...
      addonQuota: '追加额度（USD）',
      addonExpires: '有效期',
      addonExpiryDays: '{days} 天',
      addonFollowSubscription: '跟随订阅到期',
      addonCalculatedExpires: '预计到期',
      addonExpiryUnavailable: '订阅剩余时间不足',
      addonNotes: '备注',
      addonHistory: '发放记录',
      addonGrant: '发放加油包',
      addonGranting: '发放中...',
      addonGranted: '加油包发放成功',
      addonGrantFailed: '加油包发放失败',
      addonInvalid: '请输入有效的额度和有效期',
      addonRevoke: '撤销',
      addonRevoked: '加油包已撤销',
      addonRevokeFailed: '撤销加油包失败',
      addonRevokeConfirm: '确定撤销这个加油包的剩余额度吗？已使用额度和流水会保留。',
      addonStatus: {
        active: '生效中',
        exhausted: '已用完',
        revoked: '已撤销',
      ...
      resetQuotaConfirm: "请选择要为 '{user}' 重置的用量窗口。选中的用量将归零，并从今天开始重新计算。",
      resetQuotaDaily: '每日用量',
      resetQuotaWeekly: '每周用量',
      resetQuotaMonthly: '每月用量',
      resetQuotaDailyHint: '24 小时滚动窗口',
      resetQuotaWeeklyHint: '7 天滚动窗口',
      resetQuotaMonthlyHint: '30 天滚动窗口',
      resetQuotaSelectAtLeastOne: '请至少选择一个要重置的用量窗口。',
      ...
      guide: {
        ...
        actions: {
          ...
          resetQuota: '重置配额',
          resetQuotaDesc: '按选择将日、周或月用量归零，重新开始计算',
          revoke: '撤销',
