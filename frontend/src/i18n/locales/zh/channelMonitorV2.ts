...
export default {
  channelMonitorV2: {
    ...
    settings: {
      ...
      platformsHint: '留空 = 只展示已启用的探测模型（渠道监控里的主模型/附加模型）；填写后按手写名单展示，其余归入「其他」',
      modelsPlaceholder: '留空=只显示探测模型；或手写名单（其余归其他）',
      badgeAllModels: '全部模型',
      badgeOther: '+ 其他',
      groupsTitle: '监控分组',
      ...
      namedModelsEmpty: '各平台模型列表为空：渠道状态只展示已启用的探测模型。',
      ...
      userContract: {
        ...
        models: '模型列表留空时只展示探测模型，不展开账号 mapping',
      },
    },
    admin: {
