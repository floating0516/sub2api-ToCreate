export default {
  ...
  auth: {
    ...
    emailFirst: {
      ...
      emailDescription: 'Enter your email first. We will keep the next step focused.',
      emailHint: 'Your email is used with the real account system.',
      continueWithEmail: 'Continue with email',
      realAccount: 'Real account',
      secureSession: 'Secure session',
      signInEyebrow: 'ACCOUNT SIGN IN',
      createEyebrow: 'NEW ACCOUNT',
      passwordHint: 'Use the password for this account.',
      ...
      twoFactorDescription: 'Enter the authenticator code for ',
      signedIn: 'SIGNED IN',
      preparingTitle: 'Preparing your account',
      preparingDescription: 'Restoring your secure session and workspace.',
      ready: 'READY',
      successTitle: "You're all set",
      successDescription: 'Your account and workspace are ready.',
      otherLoginMethods: 'Use another sign-in method',
      otherMethodsEyebrow: 'OTHER SIGN-IN METHODS',
      otherMethodsTitle: 'Choose how to sign in',
      otherMethodsDescription: 'Continue with an available account provider or passkey.',
      emailPasswordMethod: 'Use email and password',
      showPassword: 'Show password',
      hidePassword: 'Hide password',
      settingsUnavailable: 'Account settings are unavailable. Please try again.',
      legal: 'By continuing, you agree to the applicable Terms and Privacy Policy.'
    },
