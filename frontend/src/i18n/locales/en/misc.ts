export default {
  ...
  payment: {
    ...
    admin: {
      ...
      addonPrice: 'Price (USD)',
      addonUnitPrice: 'Price per $1 quota',
      addonCnyPayPreview: 'CNY channel charge preview',
      editAddonProduct: 'Edit Add-on Product',
      addonPriceChangeNotice: 'Changes affect only new orders and newly granted add-ons. Existing orders and quota remain unchanged. The SKU cannot be changed after creation.',
