export default {
  ...
  version: {
    ...
    customUpdateConflictHint:
      'The update is paused. Source, port 18080, and port 8080 are unchanged. Resolve these conflicts manually, then retry.',
    ...
    customUpdateSteps: {
      ...
      conflict_resolution: 'Check merge conflicts',
    ...
    customUpdateStates: {
      ...
      conflict_detected: 'Update paused for manual conflict resolution',
