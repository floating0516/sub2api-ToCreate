export default {
  ...
  version: {
    ...
    officialProject: 'Official Project',
    officialRepository: 'Official Repository',
    officialBaseline: 'Current Baseline',
    officialLatest: 'Official Latest',
    officialUpdateAvailable: 'Official version v{version} is available',
    officialUpdateCustomHint:
      'Merge it through the ToCreate custom update flow to preserve existing customizations.',
    officialUpToDate: 'This build is based on the latest official version.',
    officialCheckUnavailable: 'The latest official version is unavailable. Refresh to try again.',
    refresh: 'Refresh',
    ...
    customUpdateResolverSettings: 'AI settings',
    customUpdateResolverSettingsTitle: 'Automatic merge model',
    customUpdateResolverConfigSaved: 'Saved as the default for future conflict resolution',
    customUpdateResolverUsingDefaults: 'Using the server default configuration',
    customUpdateResolverConfigSavedShort: 'Saved',
    customUpdateResolverUsingDefaultsShort: 'Default',
    customUpdateResolverBaseURL: 'Base URL',
    customUpdateResolverAPIKey: 'API Key',
    customUpdateResolverAPIKeyConfigured: 'Saved',
    customUpdateResolverAPIKeyMissing: 'Not saved',
    customUpdateResolverAPIKeyKeepPlaceholder: 'Leave blank to keep the saved key',
    customUpdateResolverAPIKeyPlaceholder: 'Enter API Key',
    customUpdateResolverShowAPIKey: 'Show API Key',
    customUpdateResolverHideAPIKey: 'Hide API Key',
    customUpdateResolverModel: 'Model',
    customUpdateResolverModelLuna: 'GPT-5.6 Luna · Max (default)',
    customUpdateResolverModelTerra: 'GPT-5.6 Terra · Max',
    customUpdateResolverModelCustom: 'Custom model',
    customUpdateResolverCustomModel: 'Model ID',
    customUpdateResolverReasoningMax: 'Reasoning effort: Max',
    customUpdateResolverReasoningMaxShort: 'Max',
    customUpdateResolverTestConnection: 'Test connection',
    customUpdateResolverTesting: 'Testing',
    customUpdateResolverTestSuccess: 'Connected in {latency} ms',
    customUpdateResolverTestFailed: 'Connection test failed',
    customUpdateResolverSaveDefault: 'Save as default',
    customUpdateResolverSaveSuccess: 'Default saved; the API key is never displayed',
    customUpdateResolverLoadFailed: 'Failed to load automatic merge settings',
    customUpdateResolverSaveFailed: 'Failed to save automatic merge settings',
  ...
  payment: {
    ...
    result: {
      ...
      addonSuccess: 'Add-on Purchase Successful',
    ...
    addon: {
      ...
      guideTitle: 'Before you purchase',
      guideSubscription: 'If you have multiple subscriptions, confirm the target first. A purchased add-on cannot be moved.',
      guideUsage: 'The add-on activates automatically after the selected subscription\'s base quota is exhausted.',
      guideExpiry: 'The add-on expires with the selected subscription, and unused quota does not roll over.',
      targetSubscription: 'Target subscription',
      expiresAt: 'Subscription expires: {time}',
      selectPack: 'Select an add-on',
      unitPrice: '{price} / $1',
      quota: 'Additional quota',
      validUntil: 'Valid until',
      expiryPolicy: 'The add-on applies only to the selected subscription and activates after its base quota is exhausted. Unused quota expires with that subscription.',
      balancePayment: 'Balance payment',
      balanceSuccess: 'Add-on credited',
      buyNow: 'Buy add-on',
    },
    ...
    errors: {
      ...
      ADDON_PURCHASE_DISABLED: 'Add-on purchases are not open yet.',
      ADDON_PURCHASE_UNAVAILABLE: 'Add-on purchasing is temporarily unavailable.',
      ADDON_PRODUCT_NOT_AVAILABLE: 'This add-on is no longer available.',
      ADDON_PRODUCT_INVALID: 'The add-on configuration is invalid.',
      SUBSCRIPTION_NOT_FOUND: 'The selected subscription no longer exists. Refresh and choose again.',
      SUBSCRIPTION_NOT_ACTIVE: 'The selected subscription is inactive or expires too soon.',
      ADDON_REFUND_NOT_SUPPORTED: 'An administrator must review and revoke add-on quota before refunding it.',
    ...
    admin: {
      ...
      catalogPlans: 'Subscription plans',
      catalogAddons: 'Add-on products',
      addonSales: 'User add-on purchases',
      addonSalesHint: 'When disabled, add-ons are hidden from users while administrators can still grant them manually.',
      addonSku: 'SKU',
      addonProductName: 'Product Name',
      addonQuota: 'Quota (USD)',
      addonPrice: 'Price Parameter',
      addonUnitPrice: 'Unit price per $1 quota',
      addonCnyPayPreview: 'CNY channel',
      addonBalancePayPreview: 'Balance payment',
      addonBalanceAmount: 'Balance',
      editAddonProduct: 'Edit Add-on Product',
      addonPriceChangeNotice: 'Balance payments deduct this value in USD. CNY channels charge the same numeric value when the conversion rate is 0, or price multiplied by the configured rate. Changes affect only new orders; existing orders and quota remain unchanged. The SKU cannot be changed.',
      addonNameRequired: 'Product name is required',
      addonQuotaRequired: 'Quota must be greater than 0',
      sortOrderInvalid: 'Sort order must be an integer greater than or equal to 0',
      originalPriceInvalid: 'Original price must be greater than or equal to 0',
      paidAt: 'Paid At',
      ...
      plansPageTitle: 'Product Management',
      plansPageDesc: 'Manage subscription plans and add-on products',
