export default {
  ...
  home: {
    ...
    redesign: {
      ...
      routing: 'Routing',
      secured: 'Secured',
      gatewayStatus: 'Gateway preview',
      operational: 'Claude / GPT / Gemini',
      liveRequests: 'Example requests',
      justNow: 'Sample',
      demoLabel: 'Demo',
      exampleLatency: 'Smart routing',
      exampleRequest: 'Sample request',
      demoNow: 'Demo',
      smartRoute: 'Smart route',
      quietInfrastructure: 'Quiet infrastructure, visible results',
      builtForWorkflow: 'Built for the tools you already use',
      oneEndpoint: 'One endpoint. Every model.',
      routeReady: 'Unified route established',
