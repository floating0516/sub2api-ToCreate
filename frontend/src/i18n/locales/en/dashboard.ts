export default {
  dashboard: {
    ...
    dailyReport: {
      ...
      loading: 'The report editor is checking today\'s Token notebook…',
      retry: 'Try again',
      loadFailed: 'The report is not ready yet. Please try again shortly.',
      ...
      topModel: 'Lead: {model}',
      noTopModel: 'No lead model today',
      modelLineup: 'Today\'s model lineup',
      modelLineupCaption: 'Ranked by Token usage in a compact grid',
