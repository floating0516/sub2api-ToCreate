export default {
  dashboard: {
    ...
    dailyReport: {
      title: 'Token report for {date}',
      open: 'View daily report',
      todayReport: 'View today\'s report',
      loading: 'Generating today\'s Token report…',
      retry: 'Try again',
      loadFailed: 'The report failed to load. Please try again shortly.',
      totalTokens: 'Tokens today',
      requests: 'Requests',
      models: 'Models used',
      cacheHitRate: 'Cache hit rate',
      tokenMix: 'Input {input} · Output {output}',
      averageTokens: '{value} average per request',
      cacheRead: '{value} cache reads',
      topModel: 'Most used: {model}',
      noTopModel: 'No model usage recorded today',
      modelLineup: 'Model usage details',
      modelLineupCaption: 'Ranked by Token usage in a compact layout',
      modelCount: '{count} total',
      modelStats: '{requests} requests · {tokens} Tokens',
      modelRequests: 'Calls',
      modelTokens: 'Tokens',
      noModels: 'No model calls were recorded today',
    ...
    overview: {
      ...
      dailyAverageRequests: 'Daily Average',
      ...
      daily: 'Daily',
      hourly: 'Hourly',
      dailyScope: 'Daily usage',
      hourlyScope: '{date} hourly usage',
      ...
      cumulativeHeatmap: 'Cumulative',
      dailyToken: 'Daily Token',
      weeklyToken: 'Weekly Token',
      cumulativeToken: 'Cumulative Token',
      accountLifetime: 'All account usage',
      activeDays: 'Active days',
      tokenUsage: 'Token usage',
      windowCumulative: 'Window total',
      yearlyTotal: 'Past year total',
      activeDaysValue: '{active} / {total} active days',
      endDayUsage: 'End date',
      last7Days: 'Last 7 days',
      last30Days: 'Last 30 days',
      dailyAverage: 'Daily average',
      peakDay: 'Peak day',
      heatmapPeriod: 'Heatmap period',
      previousPeriod: 'View earlier period',
      nextPeriod: 'View newer period',
      lessUsage: 'Less',
      moreUsage: 'More',
      groupBy: 'Group by',
      groupByModel: 'Group by: Model',
      groupByApiKey: 'Group by: API Key',
      ...
      platformRanking: 'Platform Usage Ranking',
      platform: 'Platform',
      spend: 'Spend',
      cumulative: 'Cumulative',
      compositePlatform: 'Composite',
      otherPlatforms: 'Other Platforms',
      viewAllModels: 'View All Models',
      viewAllPlatforms: 'View All Platforms',
      loadFailed: 'Dashboard data failed to load. Please try again.',
      retry: 'Retry'
    }
  },
  ...
  keys: {
    ...
    modelsMore: '+{count}',
    modelsViewAll: 'View all',
    modelsCopy: 'Click to copy the model name',
    ...
    useKeyModal: {
      ...
      modelsTitle: 'Models this key can call',
      modelsHint: 'Use these model names in Codex / Claude. See Available Channels for the full list and pricing.',
      modelsEmpty: 'This group has no models to show yet.',
      viewChannels: 'Open available channels',
      openai: {
  ...
  usage: {
    ...
    errors: {
      ...
      hints: {
        auth: 'Authentication failed: the key is invalid, disabled, or copied incorrectly. Check it on the API Keys page.',
        rate_limit: 'Rate limited: requests are too fast or the upstream is overloaded. Wait a moment or lower concurrency.',
        quota: 'Quota exceeded: balance or subscription usage is used up. Top up or renew, then retry.',
        invalid_request: 'The request is invalid. Check the model name, payload, and required fields.',
        invalid_request_model: 'This group does not support that model. See Available Channels or the key page for allowed names.',
        invalid_request_context: 'The prompt is too long for this model. Shorten it and retry.',
        service_unavailable: 'No upstream account is available right now. Try another model, or retry later.',
        upstream: 'The upstream model service failed temporarily. Retry later, switch models, or contact an admin if it persists.',
        upstream_timeout: 'The upstream timed out. Please retry.',
        internal: 'The gateway hit an internal error. Retry later, or contact an admin if it persists.',
        cyber: 'The request was blocked by the safety policy. Check whether the content violates the rules.',
        other: 'The request failed. Compare the original error, or contact an admin.',
      },
      detail: {
  ...
  redeem: {
    ...
    redeemCodeHint: 'Supports one-time codes and shared campaign codes',
    redeeming: 'Redeeming...',
    ...
    codeRule1: 'One-time codes are globally single-use; shared codes are limited to once per user',
