export default {
  dashboard: {
    ...
    overview: {
      ...
      summaryCaption: 'Key usage overview',
      tokenActivity: 'Token Activity',
      heatmapGranularity: 'Heatmap granularity',
      dailyHeatmap: 'Daily',
      weeklyHeatmap: 'Weekly',
      cumulativeHeatmap: 'Cumulative',
      dailyHeatmapDescription: 'Activity based on daily usage',
      weeklyHeatmapDescription: 'Natural-week totals with one level per week',
      cumulativeHeatmapDescription: 'Running total from the start of the past-year window',
