    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          description: 'When enabled, connectivity probes and usage aggregation both run. When disabled, both jobs stop and the user entry is hidden.',
          configureLink: 'Configure probes and usage in Channel Management > Channel Monitor',
          enabled: 'Enable Channel Monitor',
          enabledHint: 'Disabling stops both the probe scheduler and usage aggregation; existing config and history are kept.',
          defaultInterval: 'Default check interval (seconds)',
          defaultIntervalHint: 'Default interval for new connectivity probes (overridable per monitor). Range 15 – 3600 seconds.',
