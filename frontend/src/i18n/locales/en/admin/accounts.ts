  ...
  accounts: {
    concurrencyDetails: {
      ...
      openai: {
        ...
        thinkingDepthHint: 'Select a model first, then choose thinking depth. The text test sends the paragraph below instead of the regular "hi" probe.',
        thinkingNone: 'Off',
        ...
        drawTestHint: 'The drawing test returns a playable SVG, not a raster image. This preview uses a built-in pelican-on-bicycle animation until the real prompt is wired.',
        customTextTestMode: 'Mode: text test',
        drawTestMode: 'Mode: drawing test',
        sendingCustomTextRequest: 'Sending custom text test request...',
        sendingDrawRequest: 'Preparing playable SVG preview...',
