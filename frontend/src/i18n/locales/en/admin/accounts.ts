  ...
  accounts: {
    concurrencyDetails: {
      ...
      openai: {
        ...
        testModeCustomText: 'Text test',
        testModeDraw: 'Drawing test',
        thinkingDepth: 'Thinking depth',
        thinkingDepthHint: 'Select a model first, then choose thinking depth. Text and drawing tests both send the prompt below to the selected GPT model.',
        thinkingNone: 'Off',
        thinkingMinimal: 'Minimal',
        thinkingLow: 'Low',
        thinkingMedium: 'Medium',
        thinkingHigh: 'High',
        thinkingXHigh: 'Highest',
        customTextPromptLabel: 'Test text',
        customTextPromptPlaceholder: 'Enter a paragraph to send to GPT',
        customTextPromptDefault:
          'Write a vivid paragraph of no more than 80 words about a pelican riding a bicycle for the first time, ending with a small unexpected twist.',
        customTextPromptHint: 'This paragraph is sent as the user message to the selected GPT model, with the chosen thinking depth.',
        drawPromptLabel: 'Drawing prompt',
        drawPromptPlaceholder: 'Create an HTML document whose content is an SVG 2D animation of a pelican riding a bicycle.',
        drawPromptDefault: '创建一个 HTML，内容是 SVG 绘制一个鹈鹕骑自行车的 2D 动画。',
        drawTestHint: 'Sends this prompt to the selected GPT model and plays the returned SVG below, not a raster image.',
        customTextTestMode: 'Mode: text test',
        drawTestMode: 'Mode: drawing test',
        sendingCustomTextRequest: 'Sending custom text test request...',
        sendingDrawRequest: 'Sending drawing test request to GPT...',
      ...
      svgPreview: 'SVG animation',
      svgPreviewAlt: 'Test SVG {index}',
      svgReceived: 'Received playable SVG #{count}',
      replaySvg: 'Replay',
      ...
      openaiQuotaHistory: {
        ...
        manualResetLegend: 'Manual reset',
        providerResetLegend: 'Official reset',
        unknownResetLegend: 'Unknown',
        resetSource: 'Reset type',
        editResetSource: 'Adjust reset type',
        closeSourceEditor: 'Close reset type editor',
        automaticResult: 'Automatic result',
        autoDetection: 'Automatic',
        saveSourceFailed: 'Failed to save reset type',
