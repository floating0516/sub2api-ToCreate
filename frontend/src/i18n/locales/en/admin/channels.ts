export default {
    ...
    subscriptions: {
      ...
      adjustDaysPlaceholder: 'Enter days',
      adjustHint: 'Enter a positive number of days. The selected mode determines whether the subscription is extended or shortened.',
      adjustModeExtend: 'Extend',
      adjustModeShorten: 'Shorten',
      adjustShortenDisabled: 'Expired subscriptions or subscriptions without an expiration cannot be shortened',
      adjustQuickDays: '{days} days',
      adjustPreview: 'Adjustment preview',
      adjustPreviewExtend: 'Extend {days} days',
      adjustPreviewShorten: 'Shorten {days} days',
      newExpiration: 'New expiration',
      newRemainingDays: 'New remaining time',
      remainingDaysValue: '{days} days',
      invalidAdjustDays: 'Enter an integer from 1 to 36500 days',
      assign: 'Assign',
      assigning: 'Assigning...',
      adjust: 'Adjust',
      adjusting: 'Adjusting...',
      ...
      addonPack: 'Add-on',
      addonTitle: 'Subscription Add-on',
      addonQuota: 'Additional quota (USD)',
      addonExpires: 'Validity',
      addonExpiryDays: '{days} days',
      addonFollowSubscription: 'Until subscription expires',
      addonCalculatedExpires: 'Calculated expiration',
      addonExpiryUnavailable: 'Subscription time remaining is too short',
      addonNotes: 'Notes',
      addonHistory: 'Grant history',
      addonGrant: 'Grant add-on',
      addonGranting: 'Granting...',
      addonGranted: 'Add-on granted successfully',
      addonGrantFailed: 'Failed to grant add-on',
      addonInvalid: 'Enter a valid quota and validity period',
      addonRevoke: 'Revoke',
      addonRevoked: 'Add-on revoked',
      addonRevokeFailed: 'Failed to revoke add-on',
      addonRevokeConfirm: 'Revoke the remaining quota in this add-on? Historical usage will be retained.',
      addonStatus: {
        active: 'Active',
        exhausted: 'Exhausted',
        revoked: 'Revoked',
      ...
      resetQuotaConfirm: "Select which usage windows to reset for '{user}'. Selected usage will be zeroed and windows restarted from today.",
      resetQuotaDaily: 'Daily usage',
      resetQuotaWeekly: 'Weekly usage',
      resetQuotaMonthly: 'Monthly usage',
      resetQuotaDailyHint: '24-hour rolling window',
      resetQuotaWeeklyHint: '7-day rolling window',
      resetQuotaMonthlyHint: '30-day rolling window',
      resetQuotaSelectAtLeastOne: 'Select at least one usage window to reset.',
      ...
      guide: {
        ...
        actions: {
          ...
          resetQuota: 'Reset Quota',
          resetQuotaDesc: 'Reset selected daily, weekly, or monthly usage windows to zero',
          revoke: 'Revoke',
