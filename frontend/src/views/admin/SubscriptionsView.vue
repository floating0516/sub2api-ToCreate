      ...
      <template #filters>
        ...
        <div class="flex flex-wrap items-start justify-between gap-4">
          ...
          <div class="ml-auto flex flex-wrap items-center justify-end gap-3">
            ...
            <router-link to="/admin/benefit-grants" class="btn btn-secondary">
              <Icon name="gift" size="md" class="mr-2" />
              {{ t('admin.benefitGrants.title') }}
            </router-link>
          ...
          <template #cell-usage="{ row }">
            <div class="min-w-[280px] space-y-2">
              ...
              <div
                ...
                "
                class="flex items-center gap-2 rounded-lg bg-gradient-to-r from-primary-50 to-primary-100 px-3 py-2 dark:from-primary-900/20 dark:to-primary-800/20"
              >
