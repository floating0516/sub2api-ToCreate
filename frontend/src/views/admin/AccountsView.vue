          ...
          >
            <template #default="{ row }">
              <AccountCard
                ...
                :upstream-billing-interval-minutes="upstreamBillingProbeSettings.interval_minutes"
                :upstream-billing-now="upstreamBillingNow"
                :probing-upstream-billing="probingUpstreamBilling.has(row.id)"
                ...
                @probe-upstream-billing="handleProbeUpstreamBilling(row)"
              />
            </template>
          </AccountCardList>
        </div>
...
import type { Account, AccountPlatform, AccountType, Proxy as AccountProxy, AdminGroup, WindowStats, ClaudeModel, UpstreamBillingProbeSettings, UpstreamBillingProbeSnapshot } from '@/types'
