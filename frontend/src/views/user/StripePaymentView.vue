    ...
    <div class="mx-auto max-w-lg space-y-6 py-8" :class="isPopup ? 'px-4' : ''">
      ...
      <template v-else>
        ...
        <div v-if="order" class="card overflow-hidden">
          <div class="border-b-2 border-gray-900 bg-primary-500 px-6 py-6 text-center dark:border-gray-100">
            <p class="text-sm font-bold text-gray-900">{{ t('payment.actualPay') }}</p>
            <p class="mt-1 text-3xl font-bold text-gray-900">{{ formatGatewayAmount(order.pay_amount) }}</p>
          </div>
        </div>
        ...
        <template v-if="wechatQrUrl">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4">
              ...
              <div class="relative rounded-lg border-2 border-green-500 bg-green-50 p-4 dark:border-green-400 dark:bg-green-950/20">
                <img :src="wechatQrUrl" alt="WeChat Pay QR" class="h-56 w-56 rounded" />
                <div class="pointer-events-none absolute inset-0 flex items-center justify-center">
                  <span class="rounded-full bg-green-500 p-2 shadow ring-2 ring-white">
        ...
        <template v-else-if="redirecting">
          <div class="card p-6">
            <div class="flex flex-col items-center space-y-4 py-4">
              <div class="h-10 w-10 animate-spin rounded-full border-4 border-blue-700 border-t-transparent"></div>
