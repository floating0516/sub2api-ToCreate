...
func ProvideBillingCacheService(
	...
	return NewBillingCacheService(cache, userRepo, subRepo, apiKeyRepo, rpmCache, rateRepo, cfg, userPlatformQuotaRepo, addonRepo)
}
...
// (e.g. hide RPM/TPM throughput) and the enabled V1 probe-model catalog.
...
func ProvideChannelMonitorV2Aggregator(repo ChannelMonitorV2Repository, db *sql.DB, settingService *SettingService) *ChannelMonitorV2Aggregator {
	...
	scheduleBackgroundStart("ChannelMonitorV2Aggregator", aggregator.Start)
	return aggregator
}
