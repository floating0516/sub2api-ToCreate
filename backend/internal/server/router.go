...
func SetupRouter(
	...
	if web.HasEmbeddedFrontend() {
		...
		if err != nil { //nolint:staticcheck // The !embed stub always errors; embed builds can succeed.
...
func registerRoutes(
	...
	routes.RegisterLiheOAuthRoutes(r, v1, h, jwtAuth, adminAuth, auditLog, settingService)
	routes.RegisterLiheOIDCRoutes(r, v1, h, jwtAuth, auditLog, settingService, redisClient)
