...
func registerCustomBuildRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	customBuild := admin.Group("/custom-build")
	{
		...
		customBuild.POST("/update/resolver-config/test", h.Admin.CustomBuild.TestCustomUpdateResolverConfig)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/:id/concurrency-details", h.Admin.Account.GetConcurrencyDetails)
...
func registerOpenAIOAuthRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	openai := admin.Group("/openai")
	{
		...
		openai.GET("/accounts/:id/quota-history", h.Admin.OpenAIOAuth.QueryQuotaHistory)
		openai.PATCH("/accounts/:id/quota-history/:cycle_id/reset-source", h.Admin.OpenAIOAuth.UpdateQuotaHistoryResetSource)
...
func registerSubscriptionRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	subscriptions := admin.Group("/subscriptions")
	{
		...
		subscriptions.GET("/retention-estimate", h.Admin.Subscription.RetentionEstimate)
		...
		subscriptions.GET("/:id/addons", h.Admin.Subscription.ListAddons)
		subscriptions.POST("/:id/addons", h.Admin.Subscription.GrantAddon)
		subscriptions.POST("/:id/addons/:addon_id/revoke", h.Admin.Subscription.RevokeAddon)
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/daily-report", h.Admin.Usage.DailyReport)
